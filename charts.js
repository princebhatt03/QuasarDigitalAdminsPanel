...
const ctx2 = document.getElementById('chartjs-line').getContext('2d');
...
const ctx3 = document.getElementById('chartjs-doughnut').getContext('2d');
...
const ctx4 = document.getElementById('chartjs-pie').getContext('2d');
